 ...
 */
@WebFilter(urlPatterns = {"/checkout.jsp", "/pannello_utente.jsp", "/ModificaInfo", "/PendingGames", "/upload"}) // Aggiungere pannello utente
public class Auth implements Filter {
    ...
    public Auth() {
        ...
        permissionsMap.put("/upload", tipoUtente.User);
    }
